...
USER_SAMPLE=$2
USER_RESULT_DIR="$USER_SAVED_JSON_DIR/visualize_saved_JSON_$USER_SAMPLE"
mkdir $USER_RESULT_DIR
#
#
# Concatenate the graph_head with the graph_json.json (which is the user saved JSON file).
#
cat graph_head.txt $USER_SAVED_JSON_DIR/graph_json.json > $USER_RESULT_DIR/graph.js
#
#
# Copy the style_master to the visualize_results_rundir/
#
cp style_master.js $USER_RESULT_DIR/style.js
#
#
...
#
python create_style_code_for_visualization.py $USER_RESULT_DIR $USER_SAVED_JSON_DIR

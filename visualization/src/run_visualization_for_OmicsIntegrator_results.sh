...
#
cat graph_head.txt $FOREST_OUTPUT_DIR/graph_json.json > $USER_RESULT_DIR/graph.js
#
#
...
#
python create_style_code_for_visualization.py $USER_RESULT_DIR $FOREST_OUTPUT_DIR
#
#
